...
from robot_nav.sim.sim_env import SIM_ENV
...
class SINGLE_SIM(SIM_ENV):
    ...
    def __init__(
        self,
        world_file="robot_nav/worlds/circle_world.yaml",
...
def main(args=None):
    ...
    sim = SINGLE_SIM(
        world_file="robot_nav/worlds/circle_world.yaml", disable_plotting=True, reward_phase=2
